...
class ViewController: UIViewController, DPImage {
    ...
    func display() {
        print("delegate display")
    }
    
    func getFoctoryClass(_ str: String) -> String {
        
        func getString(_ stirng: String) -> String {
            return "\(stirng) this is class"
        }
